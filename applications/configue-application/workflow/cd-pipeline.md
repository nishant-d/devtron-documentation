...
![](../../images/workflow-cd-pipeline/cd-pipeline-console.png)

Click on **“+”** sign on CI Pipeline to attach a CD Pipeline to it.

![](../../images/workflow-cd-pipeline/create-cd-pipeline.png)
...
![](../../images/workflow-cd-pipeline/configuring-cd-pipeline.png)
...
![](../../images/workflow-cd-pipeline/cd_pre_build.jpg)
...
![](../../images/workflow-cd-pipeline/cd_post_build.jpg)
...
![](../../images/workflow-cd-pipeline/update_pipeline_cd.jpg)

![](../../images/workflow-cd-pipeline/edit_cd_pipeline.jpg)
